...
constexpr uint16_t DEFAULT_SERVO_PRESET_DURATION_SECONDS = 10;
constexpr uint16_t MIN_SERVO_PRESET_DURATION_SECONDS = 1;
constexpr uint16_t MAX_SERVO_PRESET_DURATION_SECONDS = 3600;
constexpr uint16_t SERVO_PRESET_DURATION_STEP_SECONDS = 1;
